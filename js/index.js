...
function printCircumference(radius) {
  const circumferenceNumber = 2 * Math.PI * radius;
  console.log(circumferenceNumber.toFixed(2));
}
...
function printRectangleArea(width, length) {
  const rectangleAreaNumber = width * length;
  console.log(`The area of the rectangle is ${rectangleAreaNumber}!`);
}
